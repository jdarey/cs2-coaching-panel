        ...
        <div className="animate-rise-in animate-rise-in-delay-1 relative rounded-3xl glass-card p-7 md:p-10">
          ...
          <div className="relative z-10">
            ...
            <div className="mt-8 space-y-4 animate-rise-in animate-rise-in-delay-3" style={{ animationDelay: '180ms' }}>
              ...
              <Link
                href="/register"
                className=" relative block w-full text-center px-5 py-3.5 rounded-xl text-sm font-medium text-white glass hover:bg-white/[0.06] hover:border-white/[0.15] transition-all duration-300 overflow-hidden"
              >
                Załóż nowe konto
              </Link>
            </div>
