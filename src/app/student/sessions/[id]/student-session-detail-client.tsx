...
export function StudentSessionDetailClient({ initialSession, initialProgress }: StudentSessionDetailClientProps) {
  ...
  const statusAccent: Record<string, string> = {
    ...
    IMPLEMENTED: 'text-[#d946ef] bg-[#d946ef]/10 border-[#d946ef]/25',
  }
    ...
    <StudentLayout>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 pb-24">
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              {session.scheduledAt && (
                <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-medium text-white/65 bg-white/[0.04] border border-white/[0.08] backdrop-blur-xl">
                  <Calendar className="w-3.5 h-3.5 text-[#a594ff]" />
                  {formatDateTime(session.scheduledAt)}
                </span>
              )}
              <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-medium text-white/65 bg-white/[0.04] border border-white/[0.08] backdrop-blur-xl">
                <Clock className="w-3.5 h-3.5 text-[#a594ff]" />
        ...
        <div className="grid gap-6 lg:grid-cols-3 mb-8">
          ...
          >
            {/* Player */}
            <div className="relative aspect-video w-full bg-[#06070d]">
              {activeEmbedUrl ? (
                <iframe
                  src={activeEmbedUrl}
                ...
                >
                  <div className="relative grid place-items-center w-16 h-16 rounded-2xl bg-gradient-to-br from-[#8b7bff] to-[#5a4fff] shadow-[0_12px_32px_-8px_rgba(124,111,255,0.6)]">
                  ...
                  <ExternalLink className="w-4 h-4 text-white/40 group-hover:text-[#a594ff] transition-colors" />
                </a>
              ) : (
            ...
            {session.videos.length > 0 && (
              <div className="px-3 sm:px-4 pb-4">
                <div className="flex items-center gap-2 px-2 pt-2 pb-3 mb-1">
                  <ListVideo className="w-4 h-4 text-[#a594ff]" />
                        ...
                        <div className="flex items-center gap-3">
                          <div
                            className={cn(
                              ...
                              isActive
                                ? 'bg-gradient-to-br from-[#8b7bff] to-[#5a4fff] text-white'
                                : 'bg-white/[0.04] border border-white/[0.07] text-white/55 group-hover:text-[#a594ff]',
                            )}
                          >
          ...
          >
            ...
            <a
              ...
              className="shimmer-line relative mt-auto inline-flex items-center justify-center gap-2 px-4 py-3 rounded-xl text-sm font-medium text-white bg-white/[0.04] border border-white/[0.10] hover:bg-white/[0.07] hover:border-[#8b7bff]/30 transition-all duration-300 overflow-hidden"
            >
        ...
        {session.tags.length > 0 && (
          <div className="mb-8 rise-in" style={{ animationDelay: '0.18s' }}>
            <div className="flex items-center gap-2 mb-4">
              <Target className="w-4 h-4 text-[#a594ff]" />
            ...
            <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
              {session.tags.map((st, index) => {
                const color = st.tag.color || '#a594ff'
                return (
                  <div
                    key={st.tag.id}
              ...
              <div>
                ...
                <div className="grid gap-3 sm:grid-cols-3">
                  ...
                  <div className="rounded-2xl p-4 bg-white/[0.02] border border-white/[0.06]">
                    ...
                    <p className="text-2xl font-display font-bold text-[#a594ff] mt-0.5">{completionPct}%</p>
                  </div>
                </div>
              </div>
            </div>
                  ...
                  >
                    <div className="grid lg:grid-cols-[auto_1fr] gap-0">
                      ...
                      <button
                        ...
                        className="relative w-full lg:w-64 aspect-video lg:aspect-auto bg-[#06070d] overflow-hidden group"
                      >
                        {video.thumbnail ? (
                          <img
                            src={video.thumbnail}
                      ...
                      <div className="p-5 flex flex-col">
                        ...
                        {video.tags.length > 0 && (
                          <div className="flex flex-wrap gap-1.5 mb-4">
                            {video.tags.map((vt) => {
                              const color = vt.tag.color || '#a594ff'
                              return (
                                <span
                                  key={vt.tag.id}
                          ...
                          <div className="flex flex-wrap items-center gap-2">
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              <button
                                ...
                                className="inline-flex items-center gap-1.5 px-3 py-2 rounded-xl text-xs font-medium text-white bg-white/[0.04] border border-white/[0.10] hover:bg-[#7c6fff]/15 hover:border-[#7c6fff]/40 hover:text-[#a594ff] transition-all duration-300"
                              >
            ...
            >
              <form onSubmit={handleAddNote} className="space-y-4">
                <Textarea
                  ...
                  rows={3}
                  className="min-h-[110px] rounded-2xl bg-white/[0.03] border border-white/[0.08] text-white placeholder:text-white/30 focus-visible:border-[#8b7bff]/50 focus-visible:ring-2 focus-visible:ring-[#7c6fff]/25 transition-all duration-300 resize-none"
                />
                <button
                  type="submit"
                  ...
                  >
                    <div className="flex items-start gap-3">
                      <Avatar className="h-9 w-9 rounded-xl ring-1 ring-white/10 flex-shrink-0">
                        ...
                        <AvatarFallback className="text-xs bg-gradient-to-br from-[#8b7bff] to-[#5a4fff] text-white">
                          {note.user.name?.[0] || 'U'}
                        </AvatarFallback>
                      </Avatar>
                      <div className="flex-1 min-w-0">
                          ...
                          <span
                            className={cn(
                              ...
                              note.user.role === 'COACH'
                                ? 'text-[#a594ff] bg-[#a594ff]/10 border-[#a594ff]/25'
                        ...
                        {note.isPrivate && (
                          <span className="mt-2 inline-flex items-center gap-1 text-[10px] px-2 py-0.5 rounded-full font-medium text-[#d946ef] bg-[#d946ef]/10 border border-[#d946ef]/25">
          ...
          >
            ...
            >
              <div className="flex items-center gap-2 mb-5">
                <div className="grid place-items-center w-9 h-9 rounded-xl bg-gradient-to-br from-[#8b7bff] to-[#5a4fff]">
              ...
              <div className="space-y-5">
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    rows={3}
                    className="rounded-2xl bg-white/[0.03] border border-white/[0.08] text-white placeholder:text-white/30 focus-visible:border-[#8b7bff]/50 focus-visible:ring-2 focus-visible:ring-[#7c6fff]/25 transition-all duration-300 resize-none"
                  />
                </div>
