                ...
                >
                  ...
                  <div className="relative aspect-video rounded-3xl overflow-hidden ring-1 ring-white/10">
                    ...
                    {embedUrl && (
                      ...
                      >
                        <span className="yt-force-dark inline-flex items-center gap-2 rounded-full px-5 py-2 text-xs font-bold uppercase tracking-widest text-white bg-[#a78bfa]/90 backdrop-blur-md ring-1 ring-white/40 shadow-[0_8px_28px_-6px_rgba(139,92,246,0.8)] translate-y-[200%] opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500 ease-out">
