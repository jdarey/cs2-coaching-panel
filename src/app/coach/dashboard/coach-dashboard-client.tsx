    ...
    <CoachLayout>
      <EntranceGate className="max-w-7xl mx-auto px-4 sm:px-6 pb-24" delay={400}>
        ...
        >
          <Link
            href="/coach/sessions"
            className="group relative inline-flex items-center gap-2 overflow-hidden rounded-full px-5 py-2.5 text-sm font-semibold text-white btn-darey animate-btn-gradient ring-1 ring-white/20 hover:-translate-y-0.5 transition-all duration-300"
          >
