...
const navigation = [
  ...
  { name: 'Analityka', href: '/coach/analytics', icon: BarChart2 },
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button variant="ghost" className="w-full justify-start gap-2 px-3" size="sm">
                  ...
                  <div className="flex flex-col items-start">
                    <span className="text-sm font-medium truncate">{user?.name || 'Użytkownik'}</span>
                    <span className="text-xs text-muted-foreground">Trener</span>
                  </div>
                </Button>
              </DropdownMenuTrigger>
              <DropdownMenuContent align="end" className="w-56">
                ...
                <DropdownMenuItem asChild>
                  <Link href="/coach/settings" onClick={() => setMobileSidebarOpen(false)}>
